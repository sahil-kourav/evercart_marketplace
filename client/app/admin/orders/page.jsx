...
//                                     <td className="px-4 py-3 font-medium text-slate-800">${order.totalPrice.amount}</td>
...
//                             <p><span className="text-green-700">Name:</span> {selectedOrder.shippingAddress?.name}</p>
//                             <p><span className="text-green-700">Email:</span> {selectedOrder.shippingAddress?.email}</p>
//                             <p><span className="text-green-700">Phone:</span> {selectedOrder.shippingAddress?.phone}</p>
//                             <p><span className="text-green-700">Address:</span> {`${selectedOrder.shippingAddress?.street}, ${selectedOrder.shippingAddress?.city}, ${selectedOrder.shippingAddress?.state}, ${selectedOrder.shippingAddress?.pincode}, ${selectedOrder.shippingAddress?.country}`}</p>
//                         </div>
...
//                                         <div key={item._id || item.id || `${item.product?.id || item.product?._id}-${item.price}`}
//                                             className="flex items-center gap-4 border border-slate-100 shadow rounded p-2">
//                                             <img
//                                                 src={item.product.images?.[0]?.src || item.product.images?.[0]}
//                                                 alt={item.shippingAddress?.name}
