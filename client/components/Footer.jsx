        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 py-14 text-slate-600">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-5 text-sm leading-relaxed text-slate-500">
              Welcome to Evercart, your ultimate destination for the latest and
              ...
              {[FacebookIcon, InstagramIcon, TwitterIcon, LinkedinIcon].map(
                (Icon, i) => (
                  <Link
                    key={i}
                    href="/"
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 hover:bg-green-50 border border-slate-200 hover:border-green-300 transition"
                  >
                    <Icon />
                  </Link>
                ),
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 text-sm">
            {/* Products */}
            <div>
              <h3 className="text-slate-800 font-semibold mb-4">Products</h3>
            ...
            {/* Website */}
            <div>
              <h3 className="text-slate-800 font-semibold mb-4">Website</h3>
              <ul className="space-y-2">
                <li>
                ...
                <li>
                  <Link href="/create-store" className="hover:text-green-600">
                    Create Your Store
                  </Link>
                </li>
              </ul>
