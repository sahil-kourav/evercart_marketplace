...
const Hero = () => {
    ...
    return (
        <div className='mx-auto max-w-7xl px-4 lg:px-6 my-10'>
            <div className='flex max-xl:flex-col gap-8'>
                <div className='relative flex-1 flex flex-col bg-gradient-to-br from-green-200 via-emerald-100 to-white rounded-xl xl:min-h-100 group shadow-lg'>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-gradient-to-br from-orange-200 via-yellow-100 to-white rounded-xl p-6 px-8 group shadow'>
                        <div>
                    ...
                    <div className='flex-1 flex items-center justify-between w-full bg-gradient-to-br from-blue-200 via-sky-100 to-white rounded-xl p-6 px-8 group shadow'>
                        <div>
